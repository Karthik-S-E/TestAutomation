...
public static WebDriver driver=null;
	...
	static void createUser()
	{
		try
		{
			...
			driver.findElement(By.name("email")).sendKeys("sek@gmail.com");
			driver.findElement(By.name("username")).sendKeys("karthi");
	...
	static void modifyuser()
	{
		try {
			...
			Thread.sleep(3000);
			driver.findElement(By.name("lastName")).sendKeys("se");
			Thread.sleep(2000);
